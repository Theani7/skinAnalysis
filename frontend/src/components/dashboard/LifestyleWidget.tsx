...
export default function LifestyleWidget() {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-100 rounded-3xl shadow-sm p-6 h-full flex flex-col relative overflow-hidden">
      ...
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-blue-100/40 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={() => updateWater(1)} className="w-6 h-6 rounded-lg bg-blue-500 flex items-center justify-center text-white hover:bg-blue-600 transition-colors shadow-sm shadow-blue-500/20">
          ...
          <div className="w-full h-2.5 bg-gray-100 rounded-full overflow-hidden shadow-inner">
            <div 
              className="h-full bg-gradient-to-r from-blue-400 to-blue-500 rounded-full transition-all duration-700 ease-out relative"
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-indigo-600">{sleep} hrs</span>
            </div>
          </div>
          <div className="bg-white border border-gray-100 rounded-xl p-1.5 flex items-center shadow-sm">
            ...
            <div className="w-px h-6 bg-gray-100"></div>
            <button onClick={() => updateSleep(0.5)} className="flex-1 py-1.5 flex justify-center text-indigo-500 hover:bg-indigo-50 rounded-lg transition-colors">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              { id: 'med', label: 'Medium', color: 'bg-amber-50 text-amber-700 border-amber-200' },
              ...
              <button
                ...
                className={`py-2 rounded-xl text-xs font-bold border transition-all ${
                  stress === level.id 
                    ? `${level.color} shadow-sm ring-2 ring-transparent` 
